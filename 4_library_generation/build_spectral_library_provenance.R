...
RES <- here::here("2_annotation_auto", "sirius_all_ms2", "results")   # all-MS2 annotations + provenance
OUT <- here::here("4_library_generation", "spectral_library_provenance.xlsx")
