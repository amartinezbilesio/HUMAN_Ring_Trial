...
cpd_afekta <- read.csv(file.path(base_path, "object", "detected_peaks_afekta_HE.csv"))
cpd_hmgu <- read.csv(file.path(base_path,"object", "detected_peaks_hmgu_HE.csv"))
cpd_icl <- read.csv(file.path(base_path,  "object", "detected_peaks_icl_HE.csv"))
cpd_cembio <- read.csv(file.path(base_path, "object", "detected_peaks_cembio_HE.csv"))
